...
func TestBtcTxCreator(t *testing.T) {
	// version set
	version := uint32(2)
	var b bytes.Buffer
	...
	fmt.Println("inputTxidArr : ", inputTxidArr)
	firstInputTx := ""
	for i:=len(inputTxidArr); i>0; i-- {
		firstInputTx += inputTxidArr[i-1]
	}
	fmt.Println("fistInputTx", firstInputTx)
	...
	scriptPubKey := ""
	//outputAddr := "3PFW7kS1qpKL4pTYMfw4AWRyrVhqdgcqBs"
	outputAddr := "3G6aTZZSZ1W9Yc1vyEy8BCqHLB9Y7USXn6"
	//outputAddr := "bc1qzjeg3h996kw24zrg69nge97fw8jc4v7v7yznftzk06j3429t52vse9tkp9"
	alphabet  := base58.BitcoinAlphabet
...
func TestP2shScriptPubKey(t *testing.T) {
	pubKey := "d68faf0b1f4637ea3b9e128b849a1d2e710ecf59"
	redeemScriptHash, err := hex.DecodeString(pubKey)
	...
	log.Println(hex.EncodeToString(scriptPubKey.Bytes()))
}